...
function Projects() {
  ...
  const projectsRaw: ProjectProps[] = [
    ...
    },
    {
      ...
      images: vendinhaImageMetadata, status: 'Beta', stage: 'beta', progress: 75, lastUpdate: '2026-05-24',
...
function BuildStatus() {
  ...
  const entries = [
    ...
    { name: 'Vendinha — PDV Desktop',     stage: 'beta'      as ProjectStage, progress: 75,  lastUpdate: '2026-05-24', desc: 'App Electron para comércio local' },
